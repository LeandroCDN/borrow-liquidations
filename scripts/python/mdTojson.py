...
with open("./toproces/zerolend-linea-debt-usdc.csv", "r") as file:
...
group_size = 500  # Puedes ajustar este valor según tus necesidades
address_groups = [
...
with open("zerolend-linea-debt-usdc.txt", "w") as outfile:
